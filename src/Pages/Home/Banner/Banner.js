    ...
    return (
        <div>
            <div className='banner'>
                <div style={{ paddingTop: '200px' }} className="caption">
                    <h1 className='d-flex justify-content-center pt-5'>Enjoy the tour with</h1>
                    <h1 className='d-flex justify-content-center'>TOUR BUDDY</h1>
